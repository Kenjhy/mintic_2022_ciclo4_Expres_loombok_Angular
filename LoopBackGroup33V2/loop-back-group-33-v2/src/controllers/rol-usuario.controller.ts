...
export class RolUsuarioController {
  ...
  async find(
    ...
    return this.rolRepository.usaurios_rol(id).find(filter);
  }
  ...
  async create(
    ...
    return this.rolRepository.usaurios_rol(id).create(usuario);
  }
  ...
  async patch(
    ...
    return this.rolRepository.usaurios_rol(id).patch(usuario, where);
  }
  ...
  async delete(
    ...
    return this.rolRepository.usaurios_rol(id).delete(where);
  }
}
