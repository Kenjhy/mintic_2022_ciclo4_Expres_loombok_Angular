...
export class UsuarioVehiculoController {
  ...
  async find(
    ...
    return this.usuarioRepository.vehiculos_usuario(id).find(filter);
  }
  ...
  async create(
    ...
    return this.usuarioRepository.vehiculos_usuario(id).create(vehiculo);
  }
  ...
  async patch(
    ...
    return this.usuarioRepository.vehiculos_usuario(id).patch(vehiculo, where);
  }
  ...
  async delete(
    ...
    return this.usuarioRepository.vehiculos_usuario(id).delete(where);
  }
}
