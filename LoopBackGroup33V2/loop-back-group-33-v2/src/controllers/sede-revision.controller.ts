...
export class SedeRevisionController {
  ...
  async find(
    ...
    return this.sedeRepository.revisiones_sede(id).find(filter);
  }
  ...
  async create(
    ...
    return this.sedeRepository.revisiones_sede(id).create(revision);
  }
  ...
  async patch(
    ...
    return this.sedeRepository.revisiones_sede(id).patch(revision, where);
  }
  ...
  async delete(
    ...
    return this.sedeRepository.revisiones_sede(id).delete(where);
  }
}
