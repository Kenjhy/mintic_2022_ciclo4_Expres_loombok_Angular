...
export class RevisionRepuestoController {
  ...
  async find(
    ...
    return this.revisionRepository.repuestos_revision(id).find(filter);
  }
  ...
  async create(
    ...
    return this.revisionRepository.repuestos_revision(id).create(repuesto);
  }
  ...
  async patch(
    ...
    return this.revisionRepository.repuestos_revision(id).patch(repuesto, where);
  }
  ...
  async delete(
    ...
    return this.revisionRepository.repuestos_revision(id).delete(where);
  }
}
