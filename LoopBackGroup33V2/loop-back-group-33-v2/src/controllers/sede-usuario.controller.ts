...
export class SedeUsuarioController {
  ...
  async find(
    ...
    return this.sedeRepository.usuarios_sede(id).find(filter);
  }
  ...
  async create(
    ...
    }) usuario: Omit<Usuario, 'isUsuario'>,
  ): Promise<Usuario> {
    return this.sedeRepository.usuarios_sede(id).create(usuario);
  }
  ...
  async patch(
    ...
    return this.sedeRepository.usuarios_sede(id).patch(usuario, where);
  }
  ...
  async delete(
    ...
    return this.sedeRepository.usuarios_sede(id).delete(where);
  }
}
